...
import WidgetPieChart from "../../components/chart/WidgetPieChart";
    ...
    <>
      <SafeAreaView style={{ flex: 1 }}>
        <RBSheet
          ...
          height={
            walletRBSheet === "transfer"
              ? 555
              : walletRBSheet === "deposit"
              ? 220
              : walletRBSheet === "withdraw"
              ? 480
              : walletRBSheet === "convert"
              ? 580
              : 400
          }
          openDuration={300}
        ...
        <ScrollView contentContainerStyle={{ paddingBottom: 80, flexGrow: 1 }}>
          ...
          >
            ...
            >
              ...
              <Text
                style={{ ...FONTS.h2, color: COLORS.white, marginBottom: 4 }}
              >
                $89,120
              </Text>
              <View
              ...
              >
                ...
                <Text style={{ ...FONTS.font, color: COLORS.white }}>
                  15.20% <Text style={{ color: "#00fba6" }}>(+6.75%)</Text>
                </Text>
              </View>
            </View>
          </ImageBackground>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <Text
                    style={{ ...FONTS.h6, color: COLORS.white, marginLeft: 35 }}
                  >
                    Withdraw
                  </Text>
                </Ripple>
                ...
                <Ripple
                  onPress={() => {
                    setWalletRBSheet("deposit"), refRBSheet.current.open();
                  }}
                  style={{
                    backgroundColor: COLORS.primary,
                    flexDirection: "row",
              ...
              >
                <Ripple
                  onPress={() => {
                    setWalletRBSheet("convert"), refRBSheet.current.open();
                  }}
                >
                  <Text
                    style={{
